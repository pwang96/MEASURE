...
class DBLoginUi(QtGui.QDialog):
    """ Database login ui """
    def __init__(self, cls, quit_signal):
        ...
        self.buttonLogin.clicked.connect(self.handle_login(cls))
    ...
    def handle_login(self, cls):

        identifier = cls.db.check_user_password(self.textUsr.text(), self.textPass.text())
        if identifier:
